  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.error) {
        ...
        setEmail("");
        toast.success("successfully reset password link send to your email");
        navigation("/login");
      }
    } catch (err) {
          ...
          <div className="flex flex-col items-start justify-center gap-1">
            ...
            <div className="w-full relative">
              <input
                ...
                className="w-full ring-1 ring-gray-500 rounded-sm px-3 py-2 outline-none border-none disabled:opacity-50 disabled:cursor-not-allowed"
                value={email}
